...
--
-- Table structure for table `AuthListing`
--

DROP TABLE IF EXISTS `AuthListing`;
...
CREATE TABLE `AuthListing` (
  ...
  KEY `aid` (`aid`),
  KEY `phone` (`phone`),
  CONSTRAINT `AuthListing_ibfk_1` FOREIGN KEY (`aid`) REFERENCES `Author` (`aid`),
  CONSTRAINT `AuthListing_ibfk_2` FOREIGN KEY (`phone`) REFERENCES `Contact` (`phone_number`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `AuthListing`
--

LOCK TABLES `AuthListing` WRITE;
/*!40000 ALTER TABLE `AuthListing` DISABLE KEYS */;
INSERT INTO `AuthListing` VALUES (1,101,'970-555-1000'),(2,102,'970-555-1100'),(3,201,'303-555-1200'),(4,202,'303-555-1200'),(5,202,'303-555-1210'),(6,203,'970-555-1400'),(7,205,'970-555-1600'),(8,206,'970-555-1600'),(9,207,'970-555-1800'),(10,208,'970-555-1900'),(11,209,'970-555-2000'),(12,209,'970-555-2010'),(13,210,'970-555-2001'),(14,301,'970-555-2020'),(15,302,'970-555-2300'),(16,303,'970-555-2400'),(17,303,'970-555-2401'),(18,303,'970-555-2403'),(19,304,'970-555-2400'),(20,304,'970-555-2402'),(21,304,'970-555-2403');
/*!40000 ALTER TABLE `AuthListing` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Author` VALUES (101,'Bobby','Ewing'),(102,'Red','Skelton'),(201,'Thomas','Magnum'),(202,'Julie','Barnes'),(203,'Roger','Ramjet'),(204,'Mickey','Hart'),(205,'Grace','Slick'),(206,'Perry','Mason'),(207,'Dickey','Betts'),(208,'Waco','Kid'),(209,'Roger','Thornhill'),(210,'Scottie','Ferguson'),(301,'Barbara','Wright'),(302,'John','Crichton'),(303,'Aeon','Flux'),(304,'Robert','Crawley');
...
CREATE TABLE `Authored` (
  ...
  KEY `author` (`author`),
  KEY `book` (`book`),
  CONSTRAINT `Authored_ibfk_1` FOREIGN KEY (`author`) REFERENCES `Author` (`aid`),
  CONSTRAINT `Authored_ibfk_2` FOREIGN KEY (`book`) REFERENCES `Book` (`isbn`)
...
LOCK TABLES `Authored` WRITE;
/*!40000 ALTER TABLE `Authored` DISABLE KEYS */;
INSERT INTO `Authored` VALUES (1,101,'96-42103-10001'),(2,208,'96-42103-10001'),(3,102,'96-42103-10002'),(4,203,'96-42103-10003'),(5,201,'96-42103-10003'),(6,209,'96-42103-10004'),(7,302,'96-42103-10004'),(8,304,'96-42103-10004'),(9,204,'96-42103-10005'),(10,101,'96-42103-10006'),(11,102,'96-42103-10007'),(12,302,'96-42103-10007'),(13,209,'96-42103-10008'),(14,210,'96-42103-10008'),(15,301,'96-42103-10008'),(16,304,'96-42103-10009'),(17,207,'96-42103-10011'),(18,208,'96-42103-10011'),(19,203,'96-42103-10022'),(20,202,'96-42103-10033'),(21,202,'96-42103-10034'),(22,205,'96-42103-10040'),(23,203,'96-42103-10040'),(24,201,'96-42103-10054'),(25,202,'96-42103-10054'),(26,210,'96-42103-10068'),(27,101,'96-42103-10081'),(28,204,'96-42103-10081'),(29,102,'96-42103-10093'),(30,304,'96-42103-10109'),(31,208,'96-42103-10109'),(32,210,'96-42103-10206'),(33,301,'96-42103-10206'),(34,207,'96-42103-10300'),(35,208,'96-42103-10300'),(36,101,'96-42103-10401'),(37,203,'96-42103-10401'),(38,201,'96-42103-10502'),(39,202,'96-42103-10502'),(40,201,'96-42103-10604'),(41,303,'96-42103-10709'),(42,201,'96-42103-10709'),(43,301,'96-42103-10800'),(44,302,'96-42103-10800'),(45,102,'96-42103-10907'),(46,301,'96-42103-10907'),(47,204,'96-42103-11003'),(48,205,'96-42103-11003'),(49,206,'96-42103-11003'),(50,207,'96-42103-11003'),(51,201,'96-42103-11604'),(52,303,'96-42103-11709'),(53,201,'96-42103-11709'),(54,301,'96-42103-11800'),(55,302,'96-42103-11800');
/*!40000 ALTER TABLE `Authored` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Book` (
  ...
  CONSTRAINT `Book_ibfk_1` FOREIGN KEY (`publisher`) REFERENCES `Publisher` (`PubID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Book` VALUES ('96-42103-10001','How to Grow Tomatoes',10006,'1963-02-10'),('96-42103-10002','Mr. Smith Goes to Washington',10007,'2010-03-23'),('96-42103-10003','Studying is Your Friend',10000,'1955-04-11'),('96-42103-10004','To Have and To Cherish',10003,'2011-06-01'),('96-42103-10005','Hal Finds a Home',10003,'2001-03-15'),('96-42103-10006','Last Train to Clarksville',10004,'1999-10-30'),('96-42103-10007','How to Digitally Sign',10004,'2003-11-21'),('96-42103-10008','Sam Needs a Friend',10005,'2013-12-23'),('96-42103-10009','Downton Abbey',10002,'2005-12-14'),('96-42103-10011','Database Theory',10001,'2010-01-14'),('96-42103-10022','Challenging Puzzles',10001,'1988-03-15'),('96-42103-10033','American Football',10006,'2011-02-08'),('96-42103-10034','European Football',10003,'2015-08-08'),('96-42103-10040','Where to Start',10003,'2012-05-09'),('96-42103-10054','Lacey Discovers Herself',10002,'2013-06-12'),('96-42103-10068','Mr. Ed',10001,'2009-09-03'),('96-42103-10081','Escape from Gilligans Island',10000,'2009-03-29'),('96-42103-10093','Fixing Computers',10000,'2010-01-29'),('96-42103-10109','Red Burn',10000,'2011-01-20'),('96-42103-10206','Taks McGrill',10003,'2000-02-21'),('96-42103-10300','Eating Healthy',10004,'1999-02-16'),('96-42103-10401','How to Grow Cucumbers',10006,'1945-03-14'),('96-42103-10502','Gardening Tips',10007,'1973-08-16'),('96-42103-10604','Using the Library',10003,'1993-09-09'),('96-42103-10709','Too Many Cooks',10006,'1983-01-03'),('96-42103-10800','Green is Your Friend',10006,'2000-03-22'),('96-42103-10907','Cubs Win!',10002,'2005-06-02'),('96-42103-11003','Missing Tomorrow',10001,'2005-09-01'),('96-42103-11604','Eating in the Fort',10002,'1993-01-09'),('96-42103-11709','Green Eggs',10003,'1983-01-05'),('96-42103-11800','Blue is Your Friend',10002,'2010-03-20');
...
CREATE TABLE `Borrow` (
  ...
  CONSTRAINT `Borrow_ibfk_1` FOREIGN KEY (`item`) REFERENCES `Located` (`item`),
  CONSTRAINT `Borrow_ibfk_2` FOREIGN KEY (`borrower`) REFERENCES `Member` (`mid`)
...
INSERT INTO `Borrow` VALUES (1,1100,'2016-04-13','2016-04-17',23),(2,1100,'2016-03-09','2016-03-10',23),(3,1100,'2016-03-23','2016-03-24',2),(4,1100,'2016-05-14','2016-05-16',21),(5,1100,'2016-05-16','2016-05-16',13),(6,1100,'2016-05-18','2016-05-21',24),(7,1100,'2016-03-15','2016-03-17',16),(8,1200,'2016-04-10','2016-04-16',16),(9,1200,'2016-03-27','2016-03-29',17),(10,1200,'2016-04-15','2016-04-18',18),(11,1300,'2016-03-09','2016-03-10',10),(12,1300,'2016-05-11','2016-05-14',19),(13,1300,'2016-05-11','2016-05-12',6),(14,1300,'2016-04-20','2016-04-26',7),(15,1400,'2016-03-26','2016-03-29',11),(16,1400,'2016-03-04','2016-03-06',25),(17,1400,'2016-05-24','2016-05-29',7),(18,1400,'2016-05-06','2016-05-11',6),(19,1400,'2016-03-05','2016-03-10',27),(20,1400,'2016-03-04','2016-03-07',10),(21,1500,'2016-05-14','2016-05-16',3),(22,1500,'2016-04-02','2016-04-05',25),(23,1600,'2016-05-21','2016-05-27',19),(24,1600,'2016-05-04','2016-05-09',1),(25,1600,'2016-03-20','2016-03-20',9),(26,1600,'2016-05-10','2016-05-13',25),(27,1600,'2016-03-22','2016-03-24',20),(28,1700,'2016-05-18','2016-05-21',13),(29,1700,'2016-04-17','2016-04-18',23),(30,1700,'2016-04-17','2016-04-20',27),(31,1700,'2016-04-05','2016-04-11',3),(32,1700,'2016-03-05','2016-03-08',16),(33,1700,'2016-04-22','2016-04-28',25),(34,1800,'2016-04-25','2016-04-26',9),(35,1900,'2016-05-01','2016-05-01',7),(36,2000,'2016-04-12','2016-04-12',17),(37,2000,'2016-05-17','2016-05-21',4),(38,2000,'2016-05-09','2016-05-11',18),(39,2000,'2016-05-08','2016-05-11',5),(40,2001,'2016-04-22','2016-04-25',13),(41,2002,'2016-05-22','2016-05-27',13),(42,2002,'2016-04-21','2016-04-25',7),(43,2002,'2016-03-04','2016-03-06',16),(44,2002,'2016-04-27','2016-05-02',5),(45,2003,'2016-04-09','2016-04-14',13),(46,2003,'2016-03-14','2016-03-15',11),(47,2003,'2016-04-12','2016-04-16',15),(48,2004,'2016-05-13','2016-05-17',25),(49,2004,'2016-04-27','2016-05-02',13),(50,2004,'2016-04-21','2016-04-23',6),(51,2004,'2016-05-09','2016-05-10',26),(52,2004,'2016-05-24','2016-05-28',25),(53,2005,'2016-04-20','2016-04-22',9),(54,2006,'2016-04-04','2016-04-04',25),(55,2007,'2016-03-13','2016-03-17',24),(56,2007,'2016-03-19','2016-03-24',11),(57,2007,'2016-04-19','2016-04-20',15),(58,2008,'2016-03-12','2016-03-14',22),(59,2008,'2016-04-04','2016-04-08',27),(60,2009,'2016-03-24','2016-03-30',10),(61,2009,'2016-04-12','2016-04-15',24),(62,2009,'2016-04-10','2016-04-10',10),(63,2009,'2016-03-20','2016-03-22',8),(64,2009,'2016-04-30','2016-05-02',11),(65,2009,'2016-03-07','2016-03-13',6),(66,2009,'2016-04-12','2016-04-13',1),(67,2009,'2016-04-30','2016-05-03',24),(68,2009,'2016-04-29','2016-05-02',14),(69,2011,'2016-04-20','2016-04-20',17),(70,2011,'2016-03-09','2016-03-11',9),(71,2011,'2016-03-15','2016-03-20',16),(72,2011,'2016-05-29','0000-00-00',25),(73,2011,'2016-03-06','2016-03-08',27),(74,2011,'2016-03-10','2016-03-16',13),(75,2012,'2016-03-28','2016-03-29',8),(76,2012,'2016-03-24','2016-03-28',5),(77,2012,'2016-04-04','2016-04-09',27),(78,2012,'2016-04-26','2016-04-28',7),(79,2012,'2016-05-27','0000-00-00',1),(80,2013,'2016-04-19','2016-04-23',7),(81,2013,'2016-03-26','2016-03-29',14),(82,2013,'2016-05-17','2016-05-21',11),(83,2015,'2016-03-15','2016-03-19',8),(84,2016,'2016-04-28','2016-04-30',11),(85,2016,'2016-04-22','2016-04-28',26),(86,2016,'2016-05-09','2016-05-14',19),(87,2016,'2016-03-06','2016-03-08',26),(88,2016,'2016-03-21','2016-03-22',26),(89,2016,'2016-05-15','2016-05-15',19),(90,2017,'2016-04-20','2016-04-25',24),(91,2017,'2016-05-20','2016-05-26',20),(92,2017,'2016-03-19','2016-03-23',17),(93,2017,'2016-05-01','2016-05-05',20),(94,2017,'2016-03-14','2016-03-16',3),(95,2018,'2016-03-05','2016-03-07',11),(96,2018,'2016-03-25','2016-03-27',3),(97,2018,'2016-03-16','2016-03-20',26),(98,2018,'2016-05-10','2016-05-10',7),(99,2018,'2016-04-01','2016-04-07',11),(100,2018,'2016-04-05','2016-04-10',20),(101,2018,'2016-03-05','2016-03-11',19),(102,2018,'2016-04-20','2016-04-25',24),(103,2018,'2016-05-12','2016-05-17',19),(104,2019,'2016-03-11','2016-03-12',8),(105,2020,'2016-04-09','2016-04-10',10),(106,2020,'2016-05-13','2016-05-18',19),(107,2020,'2016-04-08','2016-04-12',17),(108,2020,'2016-05-29','0000-00-00',21),(109,2021,'2016-03-14','2016-03-16',11),(110,2021,'2016-04-29','2016-04-30',14),(111,2022,'2016-03-25','2016-03-29',8),(112,2022,'2016-05-03','2016-05-06',9),(113,2022,'2016-04-16','2016-04-21',18),(114,2022,'2016-06-01','0000-00-00',27),(115,2022,'2016-03-26','2016-03-30',16),(116,2022,'2016-03-27','2016-03-29',17),(117,2022,'2016-03-26','2016-04-01',22),(118,2022,'2016-05-06','2016-05-09',2),(119,1100,'2016-04-27','2016-04-30',55),(120,1300,'2016-05-28','2016-04-04',55),(128,2016,'2016-04-07','2016-04-08',55),(129,2021,'2016-05-21','2016-05-26',55);
...
INSERT INTO `Contact` VALUES ('303-555-1200','(h)'),('303-555-1210','(c)'),('970-555-1000','(c)'),('970-555-1010','(h)'),('970-555-1100','(o)'),('970-555-1400','(c)'),('970-555-1600','(h)'),('970-555-1800','(c)'),('970-555-1900','(h)'),('970-555-2000','(h)'),('970-555-2001','(h)'),('970-555-2010','(c)'),('970-555-2020','(c)'),('970-555-2300','(o)'),('970-555-2400','(h)'),('970-555-2401','(c)'),('970-555-2402','(c)'),('970-555-2403','(o)'),('970-555-5000','(o)'),('970-555-5010','(o)'),('970-555-5020','(o)'),('970-555-5030','(o)'),('970-555-5040','(o)'),('970-555-5050','(o)'),('970-555-5060','(o)'),('970-555-5070','(c)'),('970-555-5080','(o)');
...
CREATE TABLE `Located` (
  ...
  `copies_avail` int(11) DEFAULT NULL,
  PRIMARY KEY (`item`),
  KEY `isbn` (`isbn`),
  KEY `location` (`location`),
  CONSTRAINT `Located_ibfk_1` FOREIGN KEY (`isbn`) REFERENCES `Book` (`isbn`) ON DELETE CASCADE,
  CONSTRAINT `Located_ibfk_2` FOREIGN KEY (`location`) REFERENCES `Library` (`name`)
...
INSERT INTO `Located` VALUES (1,'96-42103-10001','Main',3,1,1,3),(2,'96-42103-10003','Main',1,1,1,1),(3,'96-42103-10004','Main',2,2,1,2),(4,'96-42103-10005','Main',1,2,1,1),(5,'96-42103-10006','Main',1,2,1,1),(6,'96-42103-10007','Main',2,3,1,2),(7,'96-42103-10008','Main',2,3,1,2),(8,'96-42103-10009','Main',2,3,1,2),(9,'96-42103-10011','Main',2,4,1,2),(10,'96-42103-10022','Main',3,4,1,3),(11,'96-42103-10033','Main',3,4,1,3),(12,'96-42103-10034','Main',1,5,2,1),(13,'96-42103-10040','Main',2,5,2,2),(14,'96-42103-10054','Main',2,5,2,2),(15,'96-42103-10068','Main',1,6,2,1),(16,'96-42103-10081','Main',1,6,2,1),(17,'96-42103-10093','Main',1,6,2,1),(18,'96-42103-10109','Main',1,6,2,1),(19,'96-42103-10206','Main',1,7,2,1),(20,'96-42103-10300','Main',2,7,2,2),(21,'96-42103-10401','Main',2,7,2,1),(22,'96-42103-10502','Main',1,7,2,1),(23,'96-42103-10604','Main',2,8,2,2),(24,'96-42103-10709','Main',3,8,2,3),(25,'96-42103-10800','Main',2,8,2,1),(26,'96-42103-10907','Main',7,8,2,7),(27,'96-42103-11003','Main',3,8,2,2),(28,'96-42103-10001','South Park',1,8,3,1),(29,'96-42103-10002','South Park',1,8,3,1),(30,'96-42103-10003','South Park',1,8,3,1),(31,'96-42103-10004','South Park',1,8,3,1),(32,'96-42103-10005','South Park',1,8,3,1),(33,'96-42103-10006','South Park',1,8,3,1),(34,'96-42103-10007','South Park',3,7,3,3),(35,'96-42103-10008','South Park',3,7,3,3),(36,'96-42103-10009','South Park',1,7,3,1),(37,'96-42103-10011','South Park',1,7,3,1),(38,'96-42103-10022','South Park',2,7,3,2),(39,'96-42103-10033','South Park',3,7,3,3),(40,'96-42103-10040','South Park',1,4,2,1),(41,'96-42103-10054','South Park',1,4,2,1),(42,'96-42103-10068','South Park',1,4,2,1),(43,'96-42103-10081','South Park',1,4,2,1),(44,'96-42103-10093','South Park',1,4,2,1),(45,'96-42103-10109','South Park',1,4,2,1),(46,'96-42103-10206','South Park',1,4,2,1),(47,'96-42103-10300','South Park',1,4,2,1),(48,'96-42103-10401','South Park',1,3,2,1),(49,'96-42103-10502','South Park',1,3,2,1),(50,'96-42103-11604','South Park',2,3,2,2),(51,'96-42103-11709','South Park',1,3,2,1),(52,'96-42103-11800','South Park',2,3,2,2),(53,'96-42103-10907','South Park',7,3,2,7),(54,'96-42103-11003','South Park',2,3,2,2),(55,'96-42103-10001','Main',3,1,1,3);
...
INSERT INTO `Member` VALUES (1000,'Wiley','Coyote','1961-09-10',''),(1100,'Bugs','Bunny','1990-06-24',''),(1200,'Olive','Oyl','1989-07-19',''),(1300,'Alice','Wonderland','1989-07-19',''),(1400,'Roger','Ramjet','1985-01-13',''),(1500,'Larry','Lujack','1940-06-06',''),(1600,'Thomas','Tankengine','1991-04-01',''),(1700,'Amber','Corwin','1970-12-01',''),(1800,'Dworkin','Barimen','1950-12-02',''),(1900,'Bel','Garion','1983-01-01',''),(2000,'Pol','Gara','1963-01-10',''),(2001,'Art','Clark','2001-12-06',''),(2002,'Edith','Crawley','1962-09-04',''),(2003,'John','Bates','2001-12-12',''),(2004,'Thomas','Barrow','2005-05-05',''),(2005,'John','Watson','1975-02-22',''),(2006,'Jim','Moriarty','1967-03-12',''),(2007,'Walter','White','1983-05-14',''),(2008,'Skyler','White','1983-04-12',''),(2009,'Dexter','Morgan','1994-07-11',''),(2010,'Rita','Bennett','2001-11-12',''),(2011,'Sun','Kwon','1988-10-19',''),(2012,'John','Locke','2000-01-01',''),(2013,'Clair','Littleton','2001-02-01',''),(2015,'Claire','Bennet','2001-03-11',''),(2016,'Mohinder','Suresh','1993-04-15',''),(2017,'Chloe','Sullivan','2007-05-16',''),(2018,'Martha','Kent','1954-02-13',''),(2019,'Paige','Matthews','1977-03-16',''),(2020,'Leo','Wyatt','2000-10-01',''),(2021,'Buffy','Summers','2000-05-26',''),(2022,'Xander','Harris','2001-06-23','');
/*!40000 ALTER TABLE `Member` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `PubListing`
--

DROP TABLE IF EXISTS `PubListing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PubListing` (
  ...
  KEY `PubID` (`PubID`),
  KEY `phone` (`phone`),
  CONSTRAINT `PubListing_ibfk_1` FOREIGN KEY (`PubID`) REFERENCES `Publisher` (`PubID`),
  CONSTRAINT `PubListing_ibfk_2` FOREIGN KEY (`phone`) REFERENCES `Contact` (`phone_number`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `PubListing`
--

LOCK TABLES `PubListing` WRITE;
/*!40000 ALTER TABLE `PubListing` DISABLE KEYS */;
INSERT INTO `PubListing` VALUES (0,10000,'970-555-5000'),(1,10001,'970-555-5010'),(2,10002,'970-555-5020'),(3,10003,'970-555-5030'),(4,10004,'970-555-5040'),(5,10005,'970-555-5050'),(6,10006,'970-555-5060'),(7,10006,'970-555-5070'),(8,10007,'970-555-5080');
/*!40000 ALTER TABLE `PubListing` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-07-12 20:15:50
